...
public class ReservationMapperTest {
    ...
    public void setUp() throws Exception {
        getConnection();
        reserationMapper = new ReservationMapper( con );
    ...
    public void testGetReservationMatch() {
        ...
        Reservation reservation = reserationMapper.getInformationFromReservationTable( 10001 );
    ...
    public void testGetReservationNoMatch() {
        {
            Reservation reservation = reserationMapper.getInformationFromReservationTable( 56 );
...
//        int reservationNo = reserationMapper.getNextRegistrationNo();
//        Reservation newReservation = new Reservation( reservationNo, sqlArrival, sqlDeparture, 10001, 5, "Y", sqlRes );
//
//        list.add( newReservation );
//        boolean blob = reserationMapper.saveInformationIntoReservationTable( list );
//
//        assertTrue( "SaveReservationTrue faild1", blob );
//
//        Reservation res = reserationMapper.getInformationFromReservationTable( reservationNo );
//        assertTrue( "SaveReservationTrue faild2", "Y".equals( res.getDeposit() ) );
//
//    }
//    @Test
//    public void testUpdateReservation() throws ParseException {
//        HashMap<Integer, Reservation> listOfReservations = reserationMapper.getAllInformationFromReservationTable();
//        boolean blob;
//        DateFormat into = new SimpleDateFormat( "DD-MMM-YY" );
//        Date today = new Date();
//        Date df = into.parse( "06-MAR-14" );
...
//        java.sql.Date sqlDeparture = new java.sql.Date( df1.getTime() );
//        Reservation reserv;
//        reserv = reserationMapper.getInformationFromReservationTable( 10001 );
//
...
//        }
//        blob = reserationMapper.updateInformationIntoReservationTable( listOfReservations );
...
//    }
    ...
    public void testDeletingReservation() {
        ...
        boolean blob;
        Reservation reserv;
        int reservationNo = reserationMapper.getNextRegistrationNo() - 1;
        reserv = reserationMapper.getInformationFromReservationTable( reservationNo );
        if ( !listOfReservations.contains( reserv.getReservation_no() ) ) {
            listOfReservations.add( reserv.getReservation_no() );
        }
        blob = reserationMapper.deleteReservation( listOfReservations );
